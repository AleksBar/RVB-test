...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  ...
  !function (e, t) {
    if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof2(module))) module.exports = t();else if ("function" == typeof define && define.amd) define([], t);else {
      var a = t();
    ...
    return function () {
      ...
      var e = {
        ...
        219: function _(e, t, a) {
          ...
          function s(e) {
            return (s = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (e) {
              return _typeof2(e);
            } : function (e) {
              return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : _typeof2(e);
            })(e);
        ...
        2394: function _(e, t, a) {
          ...
          function v(e) {
            return (v = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (e) {
              return _typeof2(e);
            } : function (e) {
              return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : _typeof2(e);
            })(e);
              ...
              if (d) k();else switch (r.charAt(0)) {
                ...
                case a.quantifiermarker[0]:
                  var E = new n.default(!1, !1, !0),
                      ...
                      _ = S[0].split(","),
                      w = isNaN(_[0]) ? _[0] : parseInt(_[0]),
                      M = 1 === _.length ? w : isNaN(_[1]) ? _[1] : parseInt(_[1]),
        ...
        7149: function _() {
          function e(t) {
            return (e = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (e) {
              return _typeof2(e);
            } : function (e) {
              return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : _typeof2(e);
            })(t);
                  ...
                  if (n.isGroup && f !== n) {
                    ...
                    if (-1 === T || "string" == typeof T) {
                      ...
                      for (var F = 0; F < B.length; F++) {
                        C = parseInt(B[F]), h = [], a = "string" == typeof T && k(d, C, M) || D.slice();
                        var N = S.matches[C];
                      ...
                      h = w.concat(_), d = e, v = h.length > 0, n = _.length > 0, a = D.slice();
        ...
        7215: function _(e, t, a) {
          ...
          function l(e, t, a, i, r, s) {
            ...
            if (void 0 !== c) {
              ...
              for (-1 === A && void 0 !== t && (C.push(t), A = C.length - 1); void 0 !== S.excludes[m] && S.excludes[m].length < 10;) {
                for (S.tests = {}, o.resetMaskSet.call(x, !0), M = !0, h = 0; h < C.length && (g = M.caret || o.getLastValidPosition.call(x, void 0, !0) + 1, k = C[h], M = f.call(x, g, k, !1, i, !0)); h++) {
                  h === A && (O = M), 1 == e && M && (O = {
                    caretPos: h
                  });
                }
          ...
          function f(e, t, a, i, r, s, d) {
            ...
            if (!1 === k.keepStatic && void 0 !== y.excludes[x] && !0 !== r && !0 !== i) for (var w = x; w < (m.isRTL ? e.begin : e.end); w++) {
  ...
  var header = document.querySelector('.header'),
      ...
      inputTel = document.querySelector('#user-tel'); //   popup = document.querySelector('.popup'),
  //   popupText = document.querySelector('.popup__text'),
  //   popupEmailText = document.querySelector('.popup__email-text');

  var btns = document.querySelectorAll('button');
  var links = document.querySelectorAll('a'); // function popupEventForFreeElements(arr) {
  //     let timer = null;
  //     arr.forEach((arrElem) => {
  ...
  function scrollScript() {
    ...
    var scrollBtn = document.querySelectorAll('[data-scrollbtn]');
    ...
    scrollBtn.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        var position;
        burger.classList.remove('burger_active'); // overlay.classList.remove('overlay_active');
        ...
        anchors.forEach(function (anchor) {
          if (_this7.getAttribute('data-scrollbtn') === 'home') {
            scrlto(0);
          } else if (_this7.getAttribute('data-scrollbtn') === anchor.getAttribute('data-scroll')) {
    ...
    function arrowUp(elem, elemActive, elemHidden) {
      var arrow = document.querySelector(elem);
      var elemHeight = document.querySelector('.promo').offsetHeight / 2;
      var animatedClass = 'animate__animated';
      var animationClass = 'animate__fadeInDown';
      var animationClass2 = 'animate__fadeOutDown';
      var timer = null;
  ...
  function setScrollbarPadding(elem, elem2) {
    ...
    var myClass = elem.replace(/\./, '');
    var sclassSearch = new RegExp("(^|,) *.".concat(myClass, " *(,|$)"), 'i');
    ...
    for (var i = 0; i < rules.length; i++) {
      ...
      if (sclassSearch.test(rule.selectorText) && sclassSearch.test('.ind-r')) {
        var elemContRight = +window.getComputedStyle(elem2).marginRight.replace(/px/g, '');
        var headerContRightNew = elemContRight + scrollbarWidth;
        indRight = rule;
        indRight.style.marginRight = "".concat(headerContRightNew, "px");
        break;
      } else if (sclassSearch.test(rule.selectorText) && !sclassSearch.test('.ind-r')) {
        padRight = rule;
        padRight.style.marginRight = "".concat(scrollbarWidth, "px");
        break;
      }
    }
  }
  ...
  function closeOverlay() {
    var overlayBg = document.querySelector('.overlay__bg');
    ...
    function addPaddingForBodyWithPopup() {
      function cb(mutations, observer) {
        if (overlay.classList.contains('overlay_active') || overlay.classList.contains('overlay_active-max')) {
  ...
  function validatorForForms() {
    var validateForms = function validateForms(selector, rules, messages) {
  ...
  function headerScript() {
    function fixedHeader(headerClassAnim, headerClassFixed) {
      document.addEventListener('scroll', function () {
        var elemBottom = header.offsetHeight;

        if (document.documentElement.scrollTop > elemBottom + 20 && !header.classList.contains(headerClassFixed)) {
          setTimeout(function () {
        ...
        } else if (document.documentElement.scrollTop <= elemBottom + 20 && header.classList.contains(headerClassFixed)) {
    ...
    function clickBurger(elem) {
      var elemClass = elem.replace(/\./g, '');
      var burger = document.querySelector(elem);
      burger.addEventListener('click', function () {
        if (burger.classList.contains(elemClass + '_active')) {
          burger.classList.remove(elemClass + '_active');
          overlay.classList.remove('overlay_active'); // overlay.classList.remove('overlay_active-max');

          menu.classList.remove('header__menu_active');
          body.classList.remove('body-block'); // popup.classList.remove('popup_active');
        } else {
          burger.classList.add(elemClass + '_active');
          overlay.classList.add('overlay_active');
          menu.classList.add('header__menu_active');
          body.classList.add('body-block'); // popup.classList.remove('popup_active');
        }
      });
    }
